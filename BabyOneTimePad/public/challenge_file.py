...
if __name__ == '__main__':
    print('According to the sacred texts of Wikipedia:')
    ...
    print('This time you are allowed to magically permute the password first! Choose wisely...')
    ...
    try:
        ...
        print('Damnnn, Something went terribly wrong!')
        exit(1)
    password_guess = input('Now guys, what is my password: ')
    try:
        password_guess = bytes.fromhex(password_guess)
    except:
        print('ARHH CHARLIEEEEE! Your password guess is not even valid hex! Try again, massa!')
        exit(1)
